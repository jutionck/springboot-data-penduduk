...
public class JwtService {
    ...
    @Value("${springboot-data-penduduk.jwt.secretKey}")
    private String secretKey;

    @Value("${springboot-data-penduduk.jwt.expiration}")
    ...
    // Validasi token dan menangani exception
    private Claims extractAllClaims(String token) {
        try {
            ...
            // Token tidak sesuai format atau rusak
